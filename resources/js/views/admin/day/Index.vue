        ...
        <div class="col-md-12">
            <div class="card border-0">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <input v-model="search_hari" type="text" class="inline-block mt-1 form-control"
                                ...
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left">
                                        <div class="flex flex-row" @click="updateOrdering('hari')">
                                            <div class="font-medium text-uppercase"
                                                :class="{ 'font-bold text-blue-600': orderColumn === 'hari' }">
                                                Hari
                                            </div>
                                            <div class="select-none">
                                                <span :class="{
                                                    'text-blue-600': orderDirection === 'asc' && orderColumn === 'hari',
                                                    'hidden': orderDirection !== '' && orderDirection !== 'asc' && orderColumn === 'hari',
                                                }">&uarr;</span>
                                                <span :class="{
                                                    'text-blue-600': orderDirection === 'desc' && orderColumn === 'hari',
                                                    'hidden': orderDirection !== '' && orderDirection !== 'desc' && orderColumn === 'hari',
                                                }">&darr;</span>
                                            </div>
                                        </div>
                                    </th>
                            ...
                            <tbody>
                                <tr v-for="post in dayes.data" :key="post.id">
                ...
                <div class="card-footer">
                    <Pagination :data="dayes" :limit="3"
                        @pagination-change-page="page => getDayes(page, search_id, search_hari, search_global, orderColumn, orderDirection)"
                        class="mt-4" />
                </div>
            </div>
        </div>
...
watch(search_hari, (current, previous) => {
    getDayes(
        1,
        search_id.value,
        current,
